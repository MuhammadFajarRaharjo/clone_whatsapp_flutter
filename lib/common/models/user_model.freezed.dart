...
class _$_UserModel implements _UserModel {
  _$_UserModel(
      {required this.uid,
      required this.name,
      this.status = 'Tidak dapat bicara, WhatsApp saja',
  ...
  @override
  String toString() {
    return 'UserModel(uid: $uid, name: $name, status: $status, phoneNumber: $phoneNumber, profileImageUrl: $profileImageUrl, lastSeen: $lastSeen, active: $active, groupId: $groupId)';
  }
...
abstract class _UserModel implements UserModel {
  factory _UserModel(
      ...
      required final List<String> groupId}) = _$_UserModel;
